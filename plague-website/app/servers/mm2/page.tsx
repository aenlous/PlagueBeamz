...
export default function MM2Page() {
  const discordLinks = [
    ...
    "https://discord.gg/roblox-central-1085314691703775232",
    "https://discord.gg/celitime",
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-950 via-purple-900 to-black flex flex-col items-center justify-center p-4">
      ...
      <a
        href="/"
        className="absolute top-16 right-4 bg-red-700/80 hover:bg-red-600/90 text-white px-3 py-1 rounded-lg text-xs font-medium backdrop-blur-sm border border-red-400/30 hover:border-red-300/50 transition-all duration-300"
      >
        ← Back to Home
      </a>
      ...
      <Card className="w-full max-w-2xl bg-purple-900/30 border-purple-500/50 backdrop-blur-sm shadow-2xl shadow-purple-500/20">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-white">🔪 MM2 Servers</CardTitle>
        </CardHeader>
